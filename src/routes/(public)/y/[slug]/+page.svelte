      ...
      canvas.loadFromJSON(parsedContent, () => {
        try {
         ...
         setTimeout(() => {
          ...
          const buffer = 100;
          canvas.setHeight(maxHeight + 30); // additional 100px as per your requirement
...
////////////////////////////// TEMPLATES //////////////////////////////
  ...
  function rectTemplate(activeObject) {
    return [
      { label: 'Width', id: 'width', type: 'number', value: activeObject.width * activeObject.scaleX, min: 0, max: 1000, },
      { label: 'Height', id: 'height', type: 'number', value: activeObject.height * activeObject.scaleY, min: 0, max: 1000, },
      { label: 'Angle', id: 'angle', type: 'number', value: activeObject.angle, min: 0, max: 360 },
      { label: 'X', id: 'left', type: 'number', value: activeObject.left, min: 0, max: canvas.width },
      { label: 'Y', id: 'top', type: 'number', value: activeObject.top, min: 0, max: 1000 },
    ];
  }
